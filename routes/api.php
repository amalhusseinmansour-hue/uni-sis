...
Route::get('/setup-test-users', function () {
    ...
    if (!$program) {
        // Create a department first if needed
    ...
    if ($program) {
        ...
        $created[] = [
            ...
            'password' => 'student123',
            'role' => 'STUDENT',
            'warning' => 'No program found - student profile not created!'
        ];
    }

    // Create Finance
    $finance = \App\Models\User::updateOrCreate(
    ...
    // Create Lecturer
    $lecturer = \App\Models\User::updateOrCreate(
