...
class EnrollmentController extends Controller
{
    ...
    {
        $query = Enrollment::with(['student', 'course', 'semesterRecord']);
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Get semester info to populate required fields
        $semester = \App\Models\Semester::find($validated['semester_id']);
        $validated['semester'] = $semester->name_en ?? $semester->name ?? $semester->academic_year ?? 'N/A';
        $validated['academic_year'] = $semester->academic_year ?? date('Y') . '-' . (date('Y') + 1);

        $enrollment = Enrollment::create($validated);
        return response()->json($enrollment->load(['student', 'course', 'semesterRecord']), 201);
    }
    ...
    public function myEnrollments(Request $request): JsonResponse
    {
        ...
        $query = Enrollment::with(['course', 'semesterRecord'])
    ...
    public function enroll(Request $request): JsonResponse
    {
        ...
        $enrollment = Enrollment::create([
            ...
            'semester' => $currentSemester->name_en ?? $currentSemester->name ?? $currentSemester->academic_year ?? 'N/A',
            'academic_year' => $currentSemester->academic_year ?? date('Y') . '-' . (date('Y') + 1),
        ...
        return response()->json([
            ...
            'enrollment' => $enrollment->load(['course', 'semesterRecord']),
        ], 201);
    }
    ...
    public function lateRegistration(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'enrollment' => $enrollment->load(['student', 'course', 'semesterRecord']),
        ], 201);
    }
    ...
    public function changeSection(Request $request, Enrollment $enrollment): JsonResponse
    {
        ...
        return response()->json([
            ...
            'enrollment' => $enrollment->fresh(['student', 'course', 'semesterRecord']),
