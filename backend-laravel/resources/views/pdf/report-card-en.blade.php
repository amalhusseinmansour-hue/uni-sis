...
<head>
    ...
    <title>Report Card - {{ $data['student']['name_en'] }}</title>
    <style>
        @font-face {
...
<body>
    <div class="header">
        <div class="logo-section">
            ...
            <div class="document-title">Semester Report Card</div>
        </div>
        <div class="semester-info">
            <div class="semester-name">{{ $data['semester']['name'] }}</div>
            <div class="semester-year">Academic Year {{ $data['semester']['academic_year'] }}</div>
        </div>
    </div>
    ...
    <div class="info-section">
        <div class="info-column">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $data['student']['name_en'] }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Level:</span>
                <span class="info-value">Year {{ $data['student']['level'] }}</span>
            </div>
        </div>
        <div class="info-column">
            <div class="info-row">
                <span class="info-label">Program:</span>
                <span class="info-value">{{ $data['program']['name_en'] ?? 'N/A' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Department:</span>
                <span class="info-value">{{ $data['program']['department'] ?? 'N/A' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">College:</span>
                <span class="info-value">{{ $data['program']['college'] ?? 'N/A' }}</span>
            </div>
        </div>
    </div>
    ...
    <table class="grades-table">
        <thead>
            <tr>
                ...
                <th style="width: 30%" class="course-name">Course Name</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="course-name" style="text-align: left;">{{ $course['course_name_en'] }}</td>
    ...
    <div class="summary-section">
        <div class="summary-box">
            ...
            <div class="summary-subtitle">out of 4.00</div>
        </div>
        <div class="summary-box">
        ...
        <div class="summary-box">
            <div class="summary-title">Credits Earned</div>
            <div class="summary-value">{{ $data['summary']['earned_credits'] }}/{{ $data['summary']['total_credits'] }}</div>
            <div class="summary-subtitle">this semester</div>
        </div>
    </div>
    ...
    <div class="attendance-section">
        ...
        <div class="attendance-stats">
            <span>Attended: {{ $data['attendance']['attended_classes'] }} classes</span>
            <span>Missed: {{ $data['attendance']['missed_classes'] }} classes</span>
            <span>Rate: {{ $data['attendance']['attendance_percentage'] }}%</span>
        </div>
    </div>
    @endif
    ...
    <div class="ranking-section">
        <div class="ranking-title">Class Ranking</div>
        <div class="ranking-value">
            #{{ $data['ranking']['rank'] }} of {{ $data['ranking']['total_students'] }} students
            (Top {{ 100 - $data['ranking']['percentile'] }}%)
        </div>
    </div>
    @endif
    ...
    <div style="text-align: center;">
        @php
            $standing = $data['summary']['academic_standing'];
            $standingClass = match($standing) {
    ...
    <div class="footer">
        ...
        <div class="generated-info">
            Generated on {{ $data['generated_at'] }} | This is an official document
        </div>
    </div>
</body>
</html>
