...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('students', function (Blueprint $table) {
            ...
            // ==========================================
            $table->string('profile_picture')->nullable()->after('name_en');
            ...
            // ==========================================
            // Arabic Name Parts
            $table->string('first_name_ar')->nullable()->after('name_ar');
            $table->string('middle_name_ar')->nullable()->after('first_name_ar');
            $table->string('last_name_ar')->nullable()->after('middle_name_ar');
            $table->string('fourth_name_ar')->nullable()->after('last_name_ar');

            // English Name Parts
            $table->string('first_name_en')->nullable()->after('name_en');
            $table->string('middle_name_en')->nullable()->after('first_name_en');
            $table->string('last_name_en')->nullable()->after('middle_name_en');
            $table->string('fourth_name_en')->nullable()->after('last_name_en');
            ...
            $table->string('secondary_nationality')->nullable()->after('nationality');
            $table->string('religion')->nullable()->after('secondary_nationality');
            ...
            $table->string('residency_number')->nullable()->after('residency_type');
            $table->string('refugee_card_number')->nullable()->after('residency_number');
            $table->string('current_residence_country')->nullable()->after('refugee_card_number');
            $table->date('residency_expiry_date')->nullable()->after('current_residence_country');

            // ==========================================
            // Enhanced Contact Information
            // ==========================================
            $table->string('landline_phone')->nullable()->after('alternative_phone');
            $table->string('linkedin_profile')->nullable()->after('university_email');
            $table->string('telegram_username')->nullable()->after('linkedin_profile');
            ...
            $table->string('current_address_country')->nullable()->after('postal_code');
            $table->string('current_address_region')->nullable()->after('current_address_country');
            $table->string('current_address_city')->nullable()->after('current_address_region');
            $table->string('current_address_street')->nullable()->after('current_address_city');
            $table->string('current_address_neighborhood')->nullable()->after('current_address_street');
            $table->text('current_address_description')->nullable()->after('current_address_neighborhood');
            $table->string('current_postal_code')->nullable()->after('current_address_description');

            // ==========================================
            // Enhanced Guardian Information
            // ==========================================
            $table->string('guardian_occupation')->nullable()->after('guardian_address');
            $table->string('guardian_workplace')->nullable()->after('guardian_occupation');
            $table->string('guardian_alternative_phone')->nullable()->after('guardian_phone');

            // Mother Information
            $table->string('mother_name')->nullable()->after('guardian_workplace');
            ...
            $table->string('emergency2_name')->nullable()->after('emergency_notes');
            $table->string('emergency2_phone')->nullable()->after('emergency2_name');
            ...
            $table->string('high_school_country')->nullable()->after('high_school_track');
            $table->string('high_school_name')->nullable()->after('high_school_country');
            ...
            $table->string('high_school_seat_number')->nullable()->after('high_school_gpa');
            ...
            $table->string('first_enrollment_term')->nullable()->after('cohort');
            ...
            // Graduation Project
            $table->string('graduation_project_title')->nullable()->after('graduation_application_status');
            $table->string('graduation_project_supervisor')->nullable()->after('graduation_project_title');
            ...
            // Internship
            $table->string('internship_organization')->nullable()->after('graduation_project_grade');
