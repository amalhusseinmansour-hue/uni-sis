...
class GradeController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('Grade creation failed', ['error' => $e->getMessage(), 'data' => $validated]);
            return response()->json(['message' => 'Failed to create grade. Please try again.'], 500);
        }
    }
    ...
    public function approve(Grade $grade): JsonResponse
    {
        try {
            ...
            DB::rollBack();
            Log::error('Grade approval failed', ['grade_id' => $grade->id, 'error' => $e->getMessage()]);
            return response()->json(['message' => 'Failed to approve grade. Please try again.'], 500);
        }
    }
