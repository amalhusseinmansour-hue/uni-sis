    ...
    <body>
      <div class="container">
        ...
        <div class="header">
          <div class="university-info">
            ...
            <div class="university-name">
              ...
              <p>تعلم من أي مكان وكن قائداً في كل مكان</p>
            </div>
          </div>
        ...
        <div class="footer">
          ...
          <div class="footer-note">
            ${isRTL
              ? 'هذه الوثيقة رسمية صادرة عن النظام الأكاديمي. للتحقق من صحتها، يرجى التواصل مع إدارة القبول والتسجيل.'
              : 'This is an official document generated by the Academic System. For verification, please contact the Admissions and Registration Office.'}
          </div>
        </div>
      </div>
