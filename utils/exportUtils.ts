...
export const getUniversityDocumentStyles = (lang: 'en' | 'ar' = 'en'): string => {
  ...
  return `
    * {
    ...
    body {
      font-family: ${isRTL ? "'Segoe UI', 'Arial', sans-serif" : "'Arial', sans-serif"};
      background: #f8fafc;
      color: #1e293b;
  ...
  const htmlContent = `
    ...
    <body>
      <div class="container">
        ...
        <div class="header">
          <div class="university-info">
            <div class="university-logo">VU</div>
            <div class="university-name">
              <h1>${isRTL ? 'جامعة فيرتكس' : 'VERTIX UNIVERSITY'}</h1>
              <p>${isRTL ? 'نظام معلومات الطلاب' : 'Student Information System'}</p>
            </div>
          </div>
        ...
        <div class="footer">
          ...
          <div class="footer-note">
            ${isRTL
              ? 'هذه الوثيقة رسمية صادرة عن نظام معلومات الطلاب. للتحقق من صحتها، يرجى التواصل مع إدارة القبول والتسجيل.'
              : 'This is an official document generated by the Student Information System. For verification, please contact the Admissions and Registration Office.'}
          </div>
        </div>
      </div>
