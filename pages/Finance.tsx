...
const Finance: React.FC<FinanceProps> = ({ lang, role, student: initialStudent }) => {
  ...
  // Mock data for debtors
  const debtorsData = [
    { id: '1', studentId: 'STU-2024-001', name: 'أحمد محمد المنصور', nameEn: 'Ahmed Al-Mansour', program: 'Computer Science', level: 3, totalDue: 4500, overdueDays: 45, lastPayment: '2024-10-15', phone: '+966501234567', email: 'ahmed@student.edu' },
    { id: '2', studentId: 'STU-2024-015', name: 'سارة عبدالله العمري', nameEn: 'Sara Al-Omari', program: 'Business Admin', level: 2, totalDue: 3200, overdueDays: 30, lastPayment: '2024-11-01', phone: '+966509876543', email: 'sara@student.edu' },
    { id: '3', studentId: 'STU-2024-022', name: 'محمد خالد السعيد', nameEn: 'Mohammed Al-Saeed', program: 'Engineering', level: 4, totalDue: 6800, overdueDays: 60, lastPayment: '2024-09-20', phone: '+966507654321', email: 'mohammed@student.edu' },
    { id: '4', studentId: 'STU-2024-033', name: 'فاطمة علي الحربي', nameEn: 'Fatima Al-Harbi', program: 'Medicine', level: 3, totalDue: 12500, overdueDays: 15, lastPayment: '2024-11-10', phone: '+966503456789', email: 'fatima@student.edu' },
    { id: '5', studentId: 'STU-2024-041', name: 'عبدالرحمن سعود النمري', nameEn: 'Abdulrahman Al-Numari', program: 'Law', level: 2, totalDue: 2100, overdueDays: 20, lastPayment: '2024-11-05', phone: '+966502345678', email: 'abdulrahman@student.edu' },
  ];

  // Mock invoices data
  const invoicesData = [
    { id: 'INV-2024-001', studentId: 'STU-2024-001', studentName: 'أحمد محمد المنصور', description: 'رسوم الفصل الأول', amount: 15000, status: 'PAID', createdAt: '2024-09-01', dueDate: '2024-09-15', paidAt: '2024-09-10' },
    { id: 'INV-2024-002', studentId: 'STU-2024-015', studentName: 'سارة عبدالله العمري', description: 'رسوم الفصل الأول', amount: 12000, status: 'PENDING', createdAt: '2024-09-01', dueDate: '2024-12-01', paidAt: null },
    { id: 'INV-2024-003', studentId: 'STU-2024-022', studentName: 'محمد خالد السعيد', description: 'رسوم المختبرات', amount: 3500, status: 'OVERDUE', createdAt: '2024-10-01', dueDate: '2024-10-15', paidAt: null },
    { id: 'INV-2024-004', studentId: 'STU-2024-033', studentName: 'فاطمة علي الحربي', description: 'رسوم التسجيل', amount: 500, status: 'PAID', createdAt: '2024-08-15', dueDate: '2024-08-30', paidAt: '2024-08-25' },
    { id: 'INV-2024-005', studentId: 'STU-2024-041', studentName: 'عبدالرحمن سعود النمري', description: 'رسوم الأنشطة', amount: 800, status: 'PENDING', createdAt: '2024-11-01', dueDate: '2024-11-30', paidAt: null },
  ];

  // Receivables aging data
  const receivablesAgingData = [
    { range: lang === 'ar' ? 'حالي (0-30 يوم)' : 'Current (0-30)', amount: 125000, count: 45, color: '#22c55e' },
    { range: lang === 'ar' ? '31-60 يوم' : '31-60 Days', amount: 78500, count: 28, color: '#f59e0b' },
    { range: lang === 'ar' ? '61-90 يوم' : '61-90 Days', amount: 45200, count: 15, color: '#f97316' },
    { range: lang === 'ar' ? 'أكثر من 90 يوم' : '90+ Days', amount: 32800, count: 12, color: '#ef4444' },
  ];

  // Collection performance data
  const collectionPerformanceData = [
    { month: 'Jul', collected: 180000, target: 200000 },
    { month: 'Aug', collected: 195000, target: 200000 },
    { month: 'Sep', collected: 450000, target: 400000 },
    { month: 'Oct', collected: 380000, target: 400000 },
    { month: 'Nov', collected: 290000, target: 350000 },
    { month: 'Dec', collected: 320000, target: 380000 },
  ];

  // Program-wise receivables
  const programReceivablesData = [
    { program: lang === 'ar' ? 'الهندسة' : 'Engineering', amount: 85000, students: 32 },
    { program: lang === 'ar' ? 'الطب' : 'Medicine', amount: 120000, students: 28 },
    { program: lang === 'ar' ? 'علوم الحاسب' : 'Computer Science', amount: 65000, students: 45 },
    { program: lang === 'ar' ? 'إدارة أعمال' : 'Business', amount: 42000, students: 38 },
    { program: lang === 'ar' ? 'القانون' : 'Law', amount: 28000, students: 22 },
  ];
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          setFinancials(financialData.records || MOCK_FINANCIALS);
  ...
  const paymentHistoryData = [
    { month: 'Sep', paid: 1200, due: 0 },
    { month: 'Oct', paid: 50, due: 0 },
    { month: 'Nov', paid: 0, due: 0 },
    { month: 'Dec', paid: 0, due: 1200 },
    { month: 'Jan', paid: 750, due: 450 },
    { month: 'Feb', paid: 0, due: 450 },
  ];

  const expenseBreakdown = [
    { name: lang === 'ar' ? 'الرسوم الدراسية' : 'Tuition', value: 12000, color: '#3b82f6' },
    { name: lang === 'ar' ? 'رسوم النشاط' : 'Activity Fees', value: 500, color: '#8b5cf6' },
    { name: lang === 'ar' ? 'رسوم المكتبة' : 'Library Fees', value: 150, color: '#f59e0b' },
    { name: lang === 'ar' ? 'أخرى' : 'Other', value: 350, color: '#6b7280' },
  ];
  ...
  const paymentMethodsData = [
    { method: lang === 'ar' ? 'بطاقة ائتمان' : 'Credit Card', count: 456, color: '#3b82f6' },
    { method: lang === 'ar' ? 'تحويل بنكي' : 'Bank Transfer', count: 234, color: '#22c55e' },
    { method: lang === 'ar' ? 'نقدي' : 'Cash', count: 89, color: '#f59e0b' },
  ];
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      await financeAPI.confirmPayment({ payment_intent_id: paymentData.paymentIntentId || 'mock_payment_id' });
  ...
  if (isStudent && student) {
    const totalDue = Math.abs(student.currentBalance || balance);
    const totalPaid = student.paidAmount || 14550;
    const totalFees = student.totalFees || 15000;
    const scholarshipsTotal = myScholarships.reduce((sum, s) => sum + s.total_awarded, 0) || student.scholarships || 2000;
